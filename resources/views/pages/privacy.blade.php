...
@section('content')
<section class="py-5 legal-header">
    <div class="color-overlay"></div>
    <div class="container">
        <div class="row">
            <div class="col text-center text-white py-5">
                <h1 class="heading-1 pt-5">Privacy Notice</h1>
            </div>
        </div>
    </div>
</section>
<div class="container-fluid legal-container">
 ...
 <br><br>           
                    3. GOVERNING LAW. These Terms of Use shall be construed in accordance with and governed by the laws of Tennessee and the United States, without reference to rules regarding conflicts of law. This Site is intended for use by individuals based in the United States of America.
 ...
 <br><br>           
                    15. COPYRIGHT. All contents of Site or Service are: Copyright © 2020 My Class Of.
 ...
 <br><br>           
                    19. AMENDMENTS. Company reserves the right to amend these Terms. Should Company seek to make such an amendment, which we determine is material in our sole discretion, we shall:
