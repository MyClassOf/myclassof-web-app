...
@section('style')
    ...
    <link rel="stylesheet" href="public/css/condition.css">
@endsection

@section('content')
<div class="main">
 <section class="py-5 header-condition">
        <div class="color-overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col text-center text-white py-5">
                    <h1 class="heading-1 pt-5">Condition of Use</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row py-4">
                <div class="p-4 text-center">
                    <h2 class="py-2">Legal Notices</h2>
                    <hr>
                    <p class="py-2">
    ...
    <section class="py-5 Permitted-background">
        <div class="Permitted-color-overlay"></div>
        <div class="container Permitted-background-index">
            <div class="row py-4">
                <div class="p-4 text-center text-white">
                    <h2 class="py-2">Permitted and Prohibited Uses</h2>
                    <hr>
                    <p>
    ...
    <section class="py-5 submissions-background">
        <div class="container">
            <div class="row py-4">
                <div class="p-4 text-center">
                    ...
                    If you work for a company or at a University, it’s likely that you’re not the copyright holder of anything you make, even in your free time. Before making contributions to this site, get written permission from your employer.User Discussion Lists and Forums
        ...
        <div class="container Permitted-background-index">
            <div class="row py-4">
                <div class="p-4 text-center text-white">
                    ...
                    <p>
                    Information submitted to the Website is governed according to the Operators’ current Privacy Policy and the stated license of this website.
