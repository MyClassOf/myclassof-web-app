...
@section('content')
    ...
    @else
        <div class="container-fluid header-container">
            ...
            <div class="row">
                <div class="col-md-12 heading-text">
                    <h1>{{ $user_info[0]->first_name }} {{ $user_info[0]->last_name }}'s Grad Gifts</h1>
                    <br>
                    <p>Want to help {{ $user_info[0]->first_name }} celebrate this big achievement? Check out these great gift ideas you could help put money towards! Regardless of where your graduate is headed after graduation, I'm sure they would be happy to have your support in moving on to their next stage of life!</p>
                </div>
            </div>
        </div>
        ...
        <!-- Checkout Section -->
        <form method="POST" action="/checkout/{{ $user_info[0]->id }}">
            {{ csrf_field() }}
